...
import spring.backend.springmvcrest.exceptions.ApiError;
...
public class ExceptionHandlerController extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNotFound(Exception ex){
        ApiError apiError = new ApiError(ex.getLocalizedMessage(), "Entity not found");
        return new ResponseEntity<Object>(
                apiError, new HttpHeaders(), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler({ InvalidParametersException.class })
    public ResponseEntity<Object> handleInvalidParameters(Exception ex){
        ApiError apiError = new ApiError(ex.getLocalizedMessage(), "Parameter not found");
        return new ResponseEntity<Object>(
                apiError, new HttpHeaders(), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
        ApiError apiError = new ApiError(ex.getLocalizedMessage(), "error occurred");
        return new ResponseEntity<Object>(
